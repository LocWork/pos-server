...
CREATE TABLE "check" (
  ...
  updaterId integer DEFAULT NULL,
  updateTime timestamp without time zone DEFAULT NULL,
  runningSince timestamp without time zone NOT NULL,
...
INSERT INTO account(username,password,fullname,email,phone,status,roleid) VALUES(
	'admin','$2a$10$ZoIAJaHPngX8rnZ6RSl.neoFg8WsP/yWOE.OhuQ6/ECArQkNFbiJy','admin user','adminwork@gmail.com','0908888721','OFFLINE',(SELECT id FROM role WHERE name = 'ADMIN'));
INSERT INTO account(username,password,fullname,email,phone,status,roleid) VALUES(
	'waiter','$2a$10$ZoIAJaHPngX8rnZ6RSl.neoFg8WsP/yWOE.OhuQ6/ECArQkNFbiJy','waiter user','waiterwork@gmail.com','0908888722','OFFLINE',(SELECT id FROM role WHERE name = 'WAITER'));
INSERT INTO account(username,password,fullname,email,phone,status,roleid) VALUES(
	'waiter1','$2a$10$ZoIAJaHPngX8rnZ6RSl.neoFg8WsP/yWOE.OhuQ6/ECArQkNFbiJy','waiter user one','waiterwork1@gmail.com','0908888723','OFFLINE',(SELECT id FROM role WHERE name = 'WAITER'));	
INSERT INTO account(username,password,fullname,email,phone,status,roleid) VALUES(
	'cashier','$2a$10$ZoIAJaHPngX8rnZ6RSl.neoFg8WsP/yWOE.OhuQ6/ECArQkNFbiJy','cashier user','cashierwork@gmail.com','0908888724','OFFLINE',(SELECT id FROM role WHERE name = 'CASHIER'));
INSERT INTO account(username,password,fullname,email,phone,status,roleid) VALUES(
	'kitchen','$2a$10$ZoIAJaHPngX8rnZ6RSl.neoFg8WsP/yWOE.OhuQ6/ECArQkNFbiJy','kitchen user','kitchenwork@gmail.com','0908888725','OFFLINE',(SELECT id FROM role WHERE name = 'KITCHEN_STAFF'));
...
INSERT INTO "location"("name",status) VALUES('Khu D','INACTIVE');
INSERT INTO "location"("name",status) VALUES('Khu VIP','ACTIVE');

--Table
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'ACTIVE' AND name = 'Khu VIP'  LIMIT 1),'VIP1',10,'NOT_USE');
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'ACTIVE' AND name = 'Khu VIP'  LIMIT 1),'VIP2',10,'NOT_USE');
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'ACTIVE' AND name = 'Khu VIP'  LIMIT 1),'VIP3',20,'NOT_USE');
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'ACTIVE' AND name = 'Khu VIP'  LIMIT 1),'VIP4',20,'NOT_USE');
...
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'ACTIVE' AND name = 'Khu vực chính'  LIMIT 1),'MF11',20,'NOT_USE');
...
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'INACTIVE' AND name = 'Khu D'  LIMIT 1),'D1',2,'NOT_USE');
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'INACTIVE' AND name = 'Khu D'  LIMIT 1),'D2',2,'NOT_USE');
INSERT INTO "table"(locationid,"name",seat,status) VALUES((SELECT id FROM "location" WHERE status = 'INACTIVE' AND name = 'Khu D'  LIMIT 1),'D3',4,'NOT_USE');
...
INSERT INTO majorgroup("name",status) VALUES('Món kèm','ACTIVE');
...
--Menu and item
INSERT INTO menu(mealtypeid,isdefault,name,status) VALUES((SELECT id FROM "mealtype" WHERE status = 'ACTIVE' AND name = 'Bữa sáng'  LIMIT 1),false,'Menu bữa sáng','ACTIVE');
INSERT INTO menu(mealtypeid,isdefault,name,status) VALUES((SELECT id FROM "mealtype" WHERE status = 'ACTIVE' AND name = 'Bữa trưa'  LIMIT 1),false,'Menu bữa trưa','ACTIVE');
INSERT INTO menu(mealtypeid,isdefault,name,status) VALUES((SELECT id FROM "mealtype" WHERE status = 'ACTIVE' AND name = 'Bữa tối'  LIMIT 1),true,'Menu bữa tối','ACTIVE');
INSERT INTO menu(mealtypeid,isdefault,name,status) VALUES((SELECT id FROM "mealtype" WHERE status = 'ACTIVE' AND name = 'Bữa tối'  LIMIT 1),false,'Menu Combo','ACTIVE');
INSERT INTO menu(mealtypeid,isdefault,name,status) VALUES((SELECT id FROM "mealtype" WHERE status = 'ACTIVE' AND name = 'Mọi bữa'  LIMIT 1),true,'Menu món kèm','ACTIVE');
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Tôm chiên Tartar','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Bánh Gyoza chiên','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Sushi cá hổi','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Nấm linh chi','ACTIVE', 
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Nấm tiên','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Salad','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Mỳ tôm','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Toboki hải sản','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status,image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Món kèm' LIMIT 1),'Canh sương bò','ACTIVE',
...
INSERT INTO item(majorgroupid,name,status, image) VALUES((SELECT id FROM "majorgroup" WHERE status = 'ACTIVE' AND name = 'Tráng miệng' LIMIT 1),'COMBO thịt bò và tôm mini','ACTIVE',
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Ngô ngọt' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 10000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bò angus' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 79000);
												 
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bụng bò đơn' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 69000);	
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Lẩu rau nấm tổng hợp' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 49000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Nước ngọt Fanta' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 29000);			
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Nước ép dưa hấu' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 35000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Nước ép tropical bạc hà' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa sáng' LIMIT 1), 39000);	
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Lẩu rau nấm tổng hợp' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa trưa' LIMIT 1), 29000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bò và heo thượng hạng' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa trưa' LIMIT 1), 1090000);	
...
--Tối
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Rau củ tổng hợp' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 12000);
												 
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Ngô ngọt' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 12000);
												 
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Đậu bắp nhật' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 10000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Uyên Ương Lẩu' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1),49000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bò angus' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1),59000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Sườn mật ong' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1),69000);
												 
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bò và heo thượng hạng' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 109000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Trái cây theo mùa' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 29000);	
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Chè khúc bạch' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1),39000);	
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Rượu vang đỏ Vina Maipo' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 799000);	
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Rượu vang trắng Legende' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu bữa tối' LIMIT 1), 899000);			
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Tôm chiên Tartar' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu món kèm' LIMIT 1), 29000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'Bánh Gyoza chiên' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu món kèm' LIMIT 1), 19000);		
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO lẩu thái thập cẩm' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 399000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO lẩu thái bò sụn' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 799000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO lẩu riêu ba chỉ bò Mỹ' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 599000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO Kim Chi hải sản' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 499000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO nướng thượng hàng' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1),699000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO kem ly Hàn Quốc' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1),189000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO bánh kem mini Hàn Quốc' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 209000);												 
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO thịt bò và tôm mini' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 59000);
...
INSERT INTO menuitem(itemid,menuid,price) VALUES((SELECT id FROM "item" WHERE status = 'ACTIVE' AND name = 'COMBO lẩu hải sản 1 người' LIMIT 1), 
												 (SELECT id FROM "menu" WHERE status = 'ACTIVE' AND name = 'Menu Combo' LIMIT 1), 99000);
