...
router.get('/', async (req, res) => {
  try {
    const list =
      await pool.query(`SELECT C.id, S.name as shiftname, A.fullname, CONCAT(C.creationTime::date,' ',C.creationTime::timestamp at time zone 'utc' at time zone 'Asia/Bangkok' AS creationtime) AS creationtime,C.type, C.amount
